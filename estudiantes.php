...
$estudiantes = $db->fetchAll("
    ...
    LEFT JOIN inasistencias i ON e.id = i.estudiante_id AND i.fecha >= DATE_SUB(CURDATE(), INTERVAL 30 DAY)
    ...
    <div class="estudiantes-grid">
        ...
        <div class="estudiante-card">
            ...
            <div class="estudiante-actions">
                ...
                <a href="inasistencias.php?estudiante=<?php echo $estudiante['id']; ?>" class="btn btn-warning btn-sm">
